...
# plot_usmap(
#   data = state_proportion, values = "count", lines = "blue"
# ) + 
#   scale_fill_continuous(
#     low = "white", high = "pink", name = "proportion", label = scales::comma
#   ) + 
#   labs(title = "US States", subtitle = "placeholder") +
#   theme(legend.position = "right")


##Idk what this is or why this is idk what is going on this frucking sucks dude
```
###model building 
