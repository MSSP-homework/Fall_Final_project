...
#dont need to do this according to Ftios
```
...
null <- glm(college_edu ~ 1, balanced_com_data, family = binomial)
...
partial_pooling <- glmer(college_edu ~ libraries + amusement_parks + liquor_store + tobacco + 
                           (1 + libraries + amusement_parks + liquor_store + tobacco | state), 
                               data = balanced_com_data, 
                               family = binomial(link = "logit"))
...
#varying slope model
```{r}
slope_vary <- glmer(college_edu ~ libraries + amusement_parks + liquor_store + tobacco + (libraries + amusement_parks + liquor_store + tobacco | schid), data=mlmdata)
summary(model)
